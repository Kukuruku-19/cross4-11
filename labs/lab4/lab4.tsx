...
export default function Lab4() {
  ...
  return (
    <ScrollView style={{backgroundColor: "#85BB65"}}>
        ...
        <Pressable style={({pressed}) => [{backgroundColor: pressed ? '#F9E076' : '#FFD700'}, styles.button]} onPress={findMinArea}>
            <Text style={styles.text}>Пошук</Text>
        </Pressable>
        {arr.map(funcMap)}
        {minArea 
